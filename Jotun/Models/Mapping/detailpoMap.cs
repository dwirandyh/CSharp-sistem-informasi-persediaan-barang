...
{
    public class detailpoMap : EntityTypeConfiguration<detailpo>
    {
        public detailpoMap()
        {
            ...
            this.ToTable("detail_po", "jotun");
            this.Property(t => t.kd_detail_po).HasColumnName("kd_detail_po");
